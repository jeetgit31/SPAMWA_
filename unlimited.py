...
def logo_taekyung():
    try:
        os.system("xdg-open https://youtube.com/@ALVI_TOXIZ")
        time.sleep(3)
        os.system("clear")
        print(f"""
...
<<<<<<>>>>BY ALVI TOXIZ<<<<<>>>
  ...
  /  /____\    \     |  |_____  | |_|  |      /  /   |
 /  /      \    \    | 	     |  |      |     / _/    |
___/        \____\   |_______|   \____/     /________|
\033[1;91m\033[1;41m\033[1;97m Author: By ALVI TOXIZ \033[;0m\033[1;91m\033[1;92m
""")
    ...
    try:
        ...
        for i in range(int(power_python)):
            ...
            if "call" in jag:
                ...
                mengetik(f"{W}[{R}•{W}] SUBSCRIBE YOUTUBE ALVI TOXIZ {Y}{mr_am}")
            time.sleep(1)
